...
#     shift
# done
logdir="Scaffold_GS_Hypersim_FixAN_TrainColor"
data="ai_001_001"
gpu=-1
vsize=0.001
...
#--eval -s ./outputs/ai_035_010 --lod 0 --gpu -1 --voxel_size 0.001 --update_init_factor 4 --appearance_dim 0 --ratio 1 --iterations 30_000 --port 15650 -m outputs/ai_035_010/Scaffold_GS_Hypersim/2024-04-19
