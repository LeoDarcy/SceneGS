...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # Begin to regularization Normals
        self.begin_normal_iteration = 0#15_000
        ...
        # Only useful when normals is predicted by anchor
        self.normals_lr = 0.002
        self.env_lr = 0.002
        ...
        self.mlp_normals_lr_init = 0.008
        self.mlp_normals_lr_final = 0.00005
        self.mlp_normals_lr_delay_mult = 0.01
        self.mlp_normals_lr_max_steps = 30_000

        self.mlp_env_lr_init = 1.6e-2#0.008
        self.mlp_env_lr_final = 1.6e-3 #0.00005
        self.mlp_env_lr_delay_mult = 0.01
        self.mlp_env_lr_max_steps = 30_000
        ...
        self.lambda_normals = 0.1
        self.lambda_albedo = 0.1

        self.lambda_predicted_normal = 0.01
        ...
        self.densify_grad_threshold = 0.0002#0.06#

        # BJY parameter
        self.gt_normals = 0
        self.gt_albedo = 0# 0 is False
